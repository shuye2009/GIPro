...
public class PearsonTable{
    ...
    public void showPanel(){
        ...
        mainFrame = new JFrame("Correlation for "+pearsonInput.toString());
        
        Font headerFont = new Font("Sans Serif", Font.BOLD, 13);
        int rowHeaderWidth = colNames.get(1).length() +2; // For row headers width
        ...
        JTable rRowHeader = new RowHeaderRenderer(rTable, colNames, headerFont, rowHeaderWidth);
        ...
        JTable tRowHeader = new RowHeaderRenderer(tTestTable, colNames, headerFont, rowHeaderWidth);
        ...
        JLabel title = new JLabel("Correlation / P-value tables");
        ...
        title.setToolTipText
                ...
                + "</html>");
        JPanel northPanel = new JPanel(); northPanel.add(title);
        ...
        exportTables.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                File file = HelperMethods.showExportDialog("Selected save directory");
                //if user canceled
                if(file == null) return;
                ...
                String rFilePath = file.getAbsolutePath() +File.separator+"ICTools_correlation_matrix.txt";
                String tFilePath = file.getAbsolutePath() +File.separator+"ICTools_pvalue_matrix.txt";
        ...
        public void actionPerformed(ActionEvent ae) {
            ...
            export.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent ae) {
                    ...
                    String path = file.getAbsolutePath() +File.separator+ "/ICTools_rank_list.txt";
