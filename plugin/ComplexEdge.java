...
public class ComplexEdge implements Comparable<ComplexEdge>, Serializable{
    ...
    public double averagePearsonCorrelation(){
        double sum = 0;
        int count = 0;
        Vector<Gene> c1Genes = new Vector<Gene>(source.getGenes());
        Vector<Gene> c2Genes = new Vector<Gene>(target.getGenes());
        for (Gene g1 : c1Genes){
            for (Gene g2 : c2Genes){
    ...
    public String getInformation(){
        ...
        "<b>Complex Edge: " + source.getName() + " cc " + target.getName() + "</b><br><br>" +
        "<b>" + total + "</b> pairs (<b>" + actual + "</b> with interaction scores)<br><br>" +
        "<b>" + pos +"</b> positive relations ";
        
        if (posPValue != null){
            msg +=  "(<b>p-value: " + format.format(posPValue.doubleValue()) + "</b>)";
        }
        
        msg += "<br><b>" + neg + "</b> negative relations";
        
        if (negPValue != null){
            msg +=  " (<b>p-value: " + format.format(negPValue.doubleValue()) + "</b>)";
        }
        
        msg += "<br><b>" + zero + "</b> non interacting pair(s).<br/><br>";
