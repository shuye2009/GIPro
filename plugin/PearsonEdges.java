        ...
        for(Gene g1: pearsonInput){
            for(Gene g2: pearsonInput){
                ...
                if(r>=0){
                    ...
                    edgeAttrs.setAttribute(edge.getIdentifier(),SpecialAttributeNames.EDGE_TYPE, "rp");
                }
                //Negative, add negative attributes
                    ...
                    network.addEdge(edge);
                    edgeAttrs.setAttribute(edge.getIdentifier(),SpecialAttributeNames.EDGE_TYPE, "rn");
                }
                
                //Edge attribute for label
                DecimalFormat df = new DecimalFormat("#.###");
                edgeAttrs.setAttribute(edge.getIdentifier(), 
                                    SpecialAttributeNames.EDGE_CORR, df.format(r));
